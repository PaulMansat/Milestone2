  ...
  override def toString: String = {
    ...
    appString + attempts.map(a =>
      s"""
         ...
         |
         |Containers    : ${a.containers.map(c => s"(${c._1},${c._2})").mkString(", ")}
         |
...
object Milestone1 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    ////////////M3/////////////
    val errorCategoryPattern = ""  // TODO
    val exceptionPattern = "" // TODO
    val stagePattern = "" // TODO
    ...
    val logsFormatted = sc.textFile(fullLogFile).map(_.split("\n")).flatMap(x => x)
      ...
      .map(line => {
        ...
        ///////////M3//////////////
        val errorCategory = 0 // TODO
        val exception = ""  // TODO
        val stage = Integer.MAX_VALUE  // TODO
        val sourceCodeLine = 0  // TODO
        /////////////////////////
